...
enum BROWSER_INFO_TYPE
{
	BROWSER_INFO_APPID = 0x0000,
	BROWSER_INFO_COMMAND = 0x0001,
	BROWSER_INFO_REGISTEREDAPPNAME = 0x0002,
};

MIDL_INTERFACE("A357134E-8C1E-4EDD-8474-40A80546F54F")
IApplicationAssociationRegistrationInternal : IUnknown
{
	STDMETHOD(ClearUserAssociations)() PURE;
	STDMETHOD(SetProgIdAsDefault)(LPCWSTR, LPCWSTR, ASSOCIATIONTYPE) PURE;
	STDMETHOD(SetAppAsDefaultObsolete)(LPCWSTR, LPCWSTR, ASSOCIATIONTYPE) PURE;
...
IAssocHandlerPromptCount : IUnknown
{
...
// Windows 10 1809 used this short-lived handler metadata interface.
MIDL_INTERFACE("B4F4F4F9-2D0D-4ACB-A6EC-FF7296131313")
IAssocHandlerInfo1809 : IUnknown
{
	STDMETHOD(GetInternalProgID)(LPWSTR *ppszProgID) PURE;
};
...
IAssocHandlerMakeDefault81 : IUnknown
{
	STDMETHOD(MakeDefaultPriv)(DWORD flags) PURE;
};

MIDL_INTERFACE("6BF5F7F5-698A-401D-801A-B252D7CC3222")
IAssocHandlerMakeDefault1511 : IUnknown
{
	STDMETHOD(MakeDefaultPriv)(DWORD flags) PURE;
};

MIDL_INTERFACE("CA635855-B44E-4541-9591-9FAA53354A53")
IAssocHandlerMakeDefault1703 : IUnknown
{
	STDMETHOD(MakeDefaultPriv)(DWORD flags) PURE;
};
