...
enum AppUrlChoice
{
	APP_URL_CHOICE_APP = 0x0,
	APP_URL_CHOICE_BROWSER = 0x1,
	APP_URL_CHOICE_UNDECIDED = 0x2,
};

MIDL_INTERFACE("7BD0775A-6B34-4A94-9465-81963C09D4BA")
IAppUrlDefaults : IUnknown
{
	STDMETHOD(GetAppUrlChoice)(LPCWSTR, LPCWSTR, AppUrlChoice *) PURE;
	STDMETHOD(SetAppUrlChoice)(LPCWSTR, LPCWSTR, bool) PURE;
};