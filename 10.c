struct /*VFT*/ IApplicationAssociationRegistrationInternal_vtbl
{
  ...
  HRESULT (__fastcall *SetAppAsDefaultObsolete)(IApplicationAssociationRegistrationInternal *, const wchar_t *, const wchar_t *, ASSOCIATIONTYPE);
  ...
  HRESULT (__fastcall *ResetDefault)(IApplicationAssociationRegistrationInternal *, const wchar_t *, wchar_t **);
  HRESULT (__fastcall *TryGetHttpRelatedProgIds)(IApplicationAssociationRegistrationInternal *, const wchar_t *, const wchar_t *, wchar_t **, wchar_t **);
};
